...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARKitDraw",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ARKitDraw11AppDelegate")
...
SWIFT_CLASS("_TtC9ARKitDraw14ViewController")
...
SWIFT_CLASS("_TtC9ARKitDraw5login")
@interface login : UIViewController <UITextFieldDelegate>
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified account;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified password;
- (IBAction)RegisterAndDraw:(id _Nonnull)sender;
