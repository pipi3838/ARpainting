...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARpainting",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10ARpainting11AppDelegate")
...
SWIFT_CLASS("_TtC10ARpainting22MakeRoomViewController")
@interface MakeRoomViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified roomNameTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified passwordTextField;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)MakeRoom:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface PaintViewController : UIViewController <ARSCNViewDelegate>
